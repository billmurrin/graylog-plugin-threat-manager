...
import CreateIndicatorListButton from './CreateIndicatorListButton';

const IndicatorSummaryComponent = React.createClass({
    propTypes: {
    ...
    render() {
        ...
        if (this.state.streams.length === 0) {
            const createStreamButton = (
                <IfPermitted permissions="streams:create">
                    <CreateIndicatorListButton bsSize="small" bsStyle="link" className="btn-text"
                                        buttonText="Create one now" ref="CreateIndicatorListButton"
        ...
        const indicatorLists = this.state.filteredStreams ? (<StreamList streams={this.state.filteredStreams} streamRuleTypes={this.state.streamRuleTypes}
...
export default IndicatorSummaryComponent;