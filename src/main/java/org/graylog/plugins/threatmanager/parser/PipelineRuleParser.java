 ...
 */
package org.graylog.plugins.threatmanager.parser;
...
import org.graylog.plugins.threatmanager.ast.exceptions.PrecomputeFailure;
...
import org.graylog.plugins.threatmanager.ast.functions.FunctionArgs;
import org.graylog.plugins.threatmanager.ast.functions.FunctionDescriptor;
...
import org.graylog.plugins.threatmanager.codegen.CodeGenerator;
...
import org.graylog.plugins.threatmanager.parser.errors.IncompatibleArgumentType;
import org.graylog.plugins.threatmanager.parser.errors.IncompatibleIndexType;
import org.graylog.plugins.threatmanager.parser.errors.IncompatibleType;
import org.graylog.plugins.threatmanager.parser.errors.IncompatibleTypes;
import org.graylog.plugins.threatmanager.parser.errors.InvalidFunctionArgument;
import org.graylog.plugins.threatmanager.parser.errors.InvalidOperation;
import org.graylog.plugins.threatmanager.parser.errors.MissingRequiredParam;
import org.graylog.plugins.threatmanager.parser.errors.NonIndexableType;
import org.graylog.plugins.threatmanager.parser.errors.OptionalParametersMustBeNamed;
import org.graylog.plugins.threatmanager.parser.errors.ParseError;
import org.graylog.plugins.threatmanager.parser.errors.SyntaxError;
import org.graylog.plugins.threatmanager.parser.errors.UndeclaredFunction;
import org.graylog.plugins.threatmanager.parser.errors.UndeclaredVariable;
import org.graylog.plugins.threatmanager.parser.errors.WrongNumberOfArgs;
import org.graylog.plugins.threatmanager.processors.ConfigurationStateUpdater;
...
public class PipelineRuleParser {
    ...
    public Indicator parseRule(String rule, boolean silent) throws ParseException {
        return parseRule(rule, silent, null);
    }

    public Indicator parseRule(String rule, boolean silent, ThreatManagerClassloader classLoader) throws ParseException {
        return parseRule("dummy" + uniqueId.getAndIncrement(), rule, silent, classLoader);
    }

    public Indicator parseRule(String id, String rule, boolean silent) throws ParseException {
     ...
     */
    public Indicator parseRule(String id, String rule, boolean silent, ThreatManagerClassloader ruleClassLoader) throws ParseException {
        ...
        if (parseContext.getErrors().isEmpty()) {
            Indicator parsedRule = parseContext.getRules().get(0).withId(id);
    ...
    public List<ThreatList> parsePipelines(String pipelines) throws ParseException {
    ...
    public ThreatList parsePipeline(String id, String source) {
        final ParseContext parseContext = new ParseContext(false);
        final SyntaxErrorListener errorListener = new SyntaxErrorListener(parseContext);
        ...
        if (parseContext.getErrors().isEmpty()) {
            final ThreatList pipeline = parseContext.pipelines.get(0);
    ...
    private class RuleAstBuilder extends RuleLangBaseListener {
        ...
        public void exitRuleDeclaration(RuleLangParser.RuleDeclarationContext ctx) {
            final Indicator.Builder ruleBuilder = Indicator.builder();
            ...
            final Indicator rule = ruleBuilder.build();
    ...
    private static class ParseContext {
        ...
        public List<Indicator> rules = Lists.newArrayList();
        private Map<String, Expression> varDecls = Maps.newHashMap();
        public List<ThreatList> pipelines = Lists.newArrayList();
        ...
        public void addRule(Indicator rule) {
            this.rules.add(rule);
        }

        public List<ThreatList> getPipelines() {
            return pipelines;
        }
    ...
    private class PipelineAstBuilder extends RuleLangBaseListener {
        ...
        public void exitPipelineDeclaration(RuleLangParser.PipelineDeclarationContext ctx) {
            final ThreatList.Builder builder = ThreatList.builder();
