 ...
 */
package org.graylog.plugins.threatmanager.codegen.compiler;
...
public class JavaCompiler {
    ...
    private Map<String, byte[]> compileFromSource(@NotNull String className, @NotNull String javaCode) {
        ...
        if (!errors.isEmpty()) {
            throw new ThreatManagerCompilationException(errors);
        }
        return result;
    }

    public Class loadFromString(@NotNull ThreatManagerClassloader classLoader, @NotNull String className, @NotNull String source) throws ClassNotFoundException {
