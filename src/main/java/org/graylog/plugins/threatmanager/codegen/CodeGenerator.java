...
import org.graylog.plugins.threatmanager.ast.RuleAstBaseListener;
import org.graylog.plugins.threatmanager.ast.RuleAstWalker;
...
import org.graylog.plugins.threatmanager.codegen.compiler.JavaCompiler;
...
public class CodeGenerator {
    ...
    public static String sourceCodeForRule(Indicator rule) {
    ...
    public Class<? extends GeneratedRule> generateCompiledRule(Indicator rule, ThreatManagerClassloader ruleClassloader) {
        if (rule.id() == null) {
        ...
        try {
            ...
            return (Class<GeneratedRule>) compilerProvider.get().loadFromString(ruleClassloader, "org.graylog.plugins.threatmanager.$dynamic.rules.rule$" + rule.id() , sourceCode);
    ...
    private static class JavaPoetListener extends RuleAstBaseListener {
        ...
        public void exitRule(Indicator rule) {
            ...
            generatedFile = JavaFile.builder("org.graylog.plugins.threatmanager.$dynamic.rules", classFile.build())
                    .build();
        }
