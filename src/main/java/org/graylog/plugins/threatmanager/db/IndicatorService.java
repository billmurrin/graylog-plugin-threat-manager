...
public interface IndicatorService {
    IndicatorDao save(IndicatorDao rule);

    IndicatorDao load(String id) throws NotFoundException;

    Collection<IndicatorDao> loadAll();

    void delete(String id);

    Collection<IndicatorDao> loadNamed(Collection<String> ruleNames);
}
