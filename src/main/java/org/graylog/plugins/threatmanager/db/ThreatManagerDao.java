...
@AutoValue
public abstract class ThreatManagerDao {
    @JsonProperty("id")
    @Nullable
    @Id
    @ObjectId
    ...
    public static Builder builder() {
        return new AutoValue_ThreatManagerDao.Builder();
    }

    public abstract Builder toBuilder();

    @JsonCreator
    public static ThreatManagerDao create(@Id @ObjectId @JsonProperty("_id") @Nullable String id,
    ...
    public abstract static class Builder {
        public abstract ThreatManagerDao build();
